...
from .filters import Command, ContentTypeFilter, ExceptionsFilter, FiltersFactory, HashTag, Regexp, \
    ...
    IsSenderContact, ChatTypeFilter, AbstractFilter, ControlPrefix, StorageData
...
class Dispatcher(DataMixin, ContextInstanceMixin):
    ...
    def _setup_filters(self):
        ...
        # --- My filters ---
        filters_factory.bind(ControlPrefix, event_handlers=[
            self.message_handlers,
            self.edited_message_handlers,
            self.callback_query_handlers,
            self.inline_query_handlers,
        ])
        filters_factory.bind(StorageData, exclude_event_handlers=[])
    ...
    def message_handler(self, *custom_filters, sdata=None, text=None, cprefix=None, commands=None, regexp=None,
                        content_types=None,
                        state=None,
        ...
        def decorator(callback):
            self.register_message_handler(callback, *custom_filters, sdata=sdata, text=text, cprefix=cprefix,
    ...
    def edited_message_handler(self, *custom_filters, sdata=None, text=None, cprefix=None, commands=None, regexp=None,
                               content_types=None,
                               state=None, run_task=None, **kwargs):
        """
        ...
        def decorator(callback):
            self.register_edited_message_handler(callback, *custom_filters, sdata=sdata, text=text, cprefix=cprefix,
                                                 commands=commands,
    ...
    def channel_post_handler(self, *custom_filters, sdata=None, text=None, commands=None, regexp=None,
                             content_types=None,
                             state=None, run_task=None, **kwargs):
        """
        ...
        def decorator(callback):
            self.register_channel_post_handler(callback, *custom_filters, sdata=sdata, text=text, commands=commands,
                                               regexp=regexp, content_types=content_types, state=state,
                                               run_task=run_task, **kwargs)
            return callback
    ...
    def edited_channel_post_handler(self, *custom_filters, sdata=None, text=None, commands=None, regexp=None,
                                    content_types=None,
                                    state=None, run_task=None, **kwargs):
        """
        ...
        def decorator(callback):
            self.register_edited_channel_post_handler(callback, *custom_filters, sdata=sdata, text=text,
                                                      commands=commands,
                                                      regexp=regexp,
    ...
    def inline_handler(self, *custom_filters, sdata=None, text=None, cprefix=None, state=None, run_task=None, **kwargs):
        """
        ...
        def decorator(callback):
            self.register_inline_handler(callback, *custom_filters, sdata=sdata, text=text, cprefix=cprefix,
                                         state=state,
                                         run_task=run_task, **kwargs)
            return callback
    ...
    def chosen_inline_handler(self, *custom_filters, sdata=None, state=None, run_task=None, **kwargs):
        """
        ...
        def decorator(callback):
            self.register_chosen_inline_handler(callback, *custom_filters, sdata=sdata, state=state, run_task=run_task,
                                                **kwargs)
            return callback
    ...
    def callback_query_handler(self, *custom_filters, sdata=None, text=None, cprefix=None, state=None, run_task=None,
                               **kwargs):
        """
        ...
        def decorator(callback):
            self.register_callback_query_handler(callback, *custom_filters, sdata=sdata, text=text, cprefix=cprefix,
                                                 state=state,
                                                 run_task=run_task, **kwargs)
            return callback
    ...
    def shipping_query_handler(self, *custom_filters, sdata=None, state=None, run_task=None, **kwargs):
        """
        ...
        def decorator(callback):
            self.register_shipping_query_handler(callback, *custom_filters, sdata=sdata, state=state, run_task=run_task,
                                                 **kwargs)
            return callback
    ...
    def pre_checkout_query_handler(self, *custom_filters, sdata=None, state=None, run_task=None, **kwargs):
        """
        ...
        def decorator(callback):
            self.register_pre_checkout_query_handler(callback, *custom_filters, sdata=sdata, state=state,
                                                     run_task=run_task,
                                                     **kwargs)
            return callback
    ...
    def poll_handler(self, *custom_filters, sdata=None, text=None, run_task=None, **kwargs):
        """
        ...
        def decorator(callback):
            self.register_poll_handler(callback, *custom_filters, sdata=sdata, text=text, run_task=run_task,
                                       **kwargs)
            return callback
    ...
    def poll_answer_handler(self, *custom_filters, sdata=None, run_task=None, **kwargs):
        """
        ...
        def decorator(callback):
            self.register_poll_answer_handler(callback, *custom_filters, sdata=sdata, run_task=run_task,
                                              **kwargs)
            return callback
    ...
    def errors_handler(self, *custom_filters, sdata=None, exception=None, run_task=None, **kwargs):
        """
        ...
        def decorator(callback):
            self.register_errors_handler(self._wrap_async_task(callback, run_task),
                                         *custom_filters, sdata=sdata, exception=exception, **kwargs)
            return callback
